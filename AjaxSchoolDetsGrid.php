...
$QRY="select count(*) from members_det where rid=2";
...
$SQL="select * from members_det where rid=2";
...
{
	$s .= "<row id='". $row['usrname']."'>";
	$s .= "<cell>". $row['usrname']."</cell>";
	$s .= "<cell>". $row['s_id']."</cell>";
	$s .= "<cell>". $row['s_name']."</cell>";
	$s .= "<cell>". $row['loc']."</cell>";
	$s .= "<cell>". $row['contact_no']."</cell>";
	$s .= "<cell>". $row['email_id']."</cell>";
	$s .= "<cell>". $row['max_shuffle']."</cell>";
	$s .= "</row>";
}
$s .= "</rows>";
echo $s;
